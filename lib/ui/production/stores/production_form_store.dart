...
abstract class _ProductionFormStore with Store {
  ...
  Future<void> saveProduction() async {
    ...
    final productionEntity = ProductionEntity(
      ...
      totalCost: totalCost,
      seedCost: parseCurrency(seedCost ?? '0'),
      laborCost: parseCurrency(laborCost ?? '0,0'),
      fertilizerCost: parseCurrency(fertilizerCost ?? '0'),
      irrigationCost: parseCurrency(irrigationCost ?? '0'),
      otherCosts: parseCurrency(otherCosts ?? '0'),
